...
def test_enqueue_accepts_request_with_valid_token(
    make_event: Callable[..., dict[str, Any]],
...
def test_enqueue_accepts_lowercase_authorization_header(
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_missing_authorization_header(
    make_event: Callable[..., dict[str, Any]],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_non_bearer_scheme(
    make_event: Callable[..., dict[str, Any]],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_expired_token(
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_token_signed_with_wrong_secret(
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_token_with_wrong_audience(
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_malformed_token(
    make_event: Callable[..., dict[str, Any]],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_empty_body(
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_rejects_missing_body(
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
...
def test_enqueue_returns_server_error_when_queue_does_not_exist(
    monkeypatch: pytest.MonkeyPatch,
    make_event: Callable[..., dict[str, Any]],
    make_token: Callable[..., str],
    lambda_context: LambdaContext,
) -> None:
    monkeypatch.setenv("PRODUCER__QUEUE_URL", "https://sqs.eu-west-1.amazonaws.com/123456789012/does-not-exist")
    event = _enqueue_event(make_event, token=make_token())
